...
|---|---|---|---|---|
| 1 | Image & relationships | D1 *Je séduis* | relative pronouns (rappel) + with demonstratives; la mise en relief | ⬜ |
| 2 | Feelings & the subjunctive | D1 *Je séduis* | subjonctif présent (rappel), subjonctif passé / infinitif passé; subjonctif vs infinitif after feelings | ⬜ |
