...
Composition (deterministic, re-runnable):
  ...
  2. Corpus lines - generated FROM OUR OWN CONTENT (978 vocab cards + their
     example sentences + the 73 unit titles), so every generated line teaches
...
V_TEMPLATES = [
    ...
    '« {fr} » = "{en}". As seen in "{title}". Collect all 978.',
    'The frog already knows « {fr} » ({en}). Don\'t let a frog outpace you. Croâ.',
    'Kim probably has an opinion about « {fr} » ({en}). She has an opinion about most things. It\'s usually right.',
]
